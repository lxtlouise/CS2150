...
\begin{flalign*}
 \forall L_{i} \in L, \quad  \text{max} &\sum_{i=1}^{k}{\alpha_{ij}}  \qquad \text{s.t.} \\
 & \forall S_{ij} \in S, \quad \sum_{i=1}^{k}\alpha_{ij} \leq C_{L} , \quad j = 1, 2,... , n\\
 & \forall S_{ij} \in S, \forall L_{i} \in L, \quad \beta{j} - \alpha_{ij} \leq C_{L}\\
&\alpha_{ij} \leq 1, \quad i = 1, 2,..., k \quad \text{and} \quad j = 1, 2,... , n\\
& \alpha_{ij} \geq 0, \quad i = 1, 2,..., k \quad \text{and} \quad j = 1, 2,... , n\\
& \beta_{i} \leq 1, \quad i = 1, 2,..., k \\
& \beta_{i} \geq 0, \quad i = 1, 2,..., k
\end{flalign*}
